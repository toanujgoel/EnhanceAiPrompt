...
export const EnhanceAiLogo = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-primary-600 dark:text-primary-400">
        <path d="M12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2Z" fill="currentColor" fillOpacity="0.1"/>
        <path d="M12 4.04167C11.5833 5.41667 10.5 8.5 13.5 10C10.5 11.5 12.4167 14.5833 12 15.9583C12.4167 14.5833 13.5 11.5 10.5 10C13.5 8.5 11.5833 5.41667 12 4.04167Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M16 6.95834C15.6944 7.97223 15 10.0417 17 11C15 11.9583 16.3056 14.0278 16 15.0417" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M8 17.0417C8.30556 16.0278 9 13.9583 7 13C9 12.0417 7.69444 9.97223 8 8.95834" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const CpuChipIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-primary-600 dark:text-primary-400">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 7.5h6m-6 3h6m-6 3h6m-6 3h6m-9-9h12v6H6v-6Z" />
  </svg>
);

export const BoltIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" /></svg>
);
...
export const PhotoIcon = ({className = "w-12 h-12"}: {className?: string}) => (
...
export const SpeakerWaveIcon = ({className = "w-5 h-5"}: {className?: string}) => (
...
export const ClipboardDocumentIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.5a1.125 1.125 0 0 1 1.125-1.125h7.5a1.125 1.125 0 0 1 1.125 1.125v3.375M12 15.75h5.25m-5.25-3h5.25M12 12.75h5.25m-7.5-3h7.5" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 15h.008v.008H9V15Zm0-3h.008v.008H9v-.008Zm0-3h.008v.008H9V9Z" /></svg>
);

export const CheckIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-green-500"><path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
);
...
export const ChatBubbleLeftRightIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8"><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.15c.507.243.966.608 1.287 1.075l3.286 3.286a.75.75 0 0 1-1.06 1.06l-3.286-3.286a6.827 6.827 0 0 1-1.823-.882l-3.722.152A2.072 2.072 0 0 1 3 17.09V12.804c0-.97.616-1.813 1.5-2.097m16.5 0-.223-.044a2.072 2.072 0 0 0-1.823.882l-3.722-.152a6.827 6.827 0 0 0-1.823-.882l-3.722.152A2.072 2.072 0 0 0 3.75 8.511V7.72c0-1.136.847-2.1 1.98-2.193l3.72-.15a6.827 6.827 0 0 1 1.823.882l3.722-.152a2.072 2.072 0 0 1 1.823.882l3.722.152c1.133.093 1.98.987 1.98 2.193v.79Z" /></svg>
);
...
export const MicrophoneIcon = ({className = "w-12 h-12"}: {className?: string}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 12a5.25 5.25 0 0 0-1.32-.816l-1.092-.486a.75.75 0 0 0-.836 0l-1.092.486A5.25 5.25 0 0 0 8.25 12" />
    </svg>
);

export const StopCircleIcon = ({className = "w-12 h-12"}: {className?: string}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ArrowRightOnRectangleIcon = ({className = "w-5 h-5"}: {className?: string}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
